...
1. Nd7+ Ka8 2. Qxa7+ Kxa7 3. axb3# 1-0";
        ...
        public void TestMoves()
        {
            ...
            chessBoard.NewGame();
            chessBoard.MakePgnMove("e4",string.Empty, string.Empty, string.Empty);
            chessBoard.MakePgnMove("c6",string.Empty, string.Empty, string.Empty);
            chessBoard.MakePgnMove("d4",string.Empty, string.Empty, string.Empty);
            chessBoard.MakePgnMove("d5",string.Empty, string.Empty, string.Empty);
            chessBoard.MakePgnMove("Nc3",string.Empty, string.Empty, string.Empty);
            chessBoard.MakePgnMove("dxe4",string.Empty, string.Empty, string.Empty);
            chessBoard.MakePgnMove("Ne4",string.Empty, string.Empty, string.Empty);
            chessBoard.MakePgnMove("Nd7",string.Empty, string.Empty, string.Empty);
            chessBoard.MakePgnMove("Ng5",string.Empty, string.Empty, string.Empty);
            chessBoard.MakePgnMove("Ngf6",string.Empty, string.Empty, string.Empty);
            chessBoard.MakePgnMove("Bd3",string.Empty, string.Empty, string.Empty);
            chessBoard.MakePgnMove("e6",string.Empty, string.Empty, string.Empty);
            chessBoard.MakePgnMove("N1f3",string.Empty, string.Empty, string.Empty);
            ...
            chessBoard.NewGame();
            chessBoard.MakePgnMove("e4",string.Empty, string.Empty, string.Empty);
            chessBoard.MakePgnMove("c5",string.Empty, string.Empty, string.Empty);
            chessBoard.MakePgnMove("e5",string.Empty, string.Empty, string.Empty);
            chessBoard.MakePgnMove("d5",string.Empty, string.Empty, string.Empty);
            Assert.AreEqual("rnbqkbnr/pp2pppp/8/2ppP3/8/8/PPPP1PPP/RNBQKBNR w KQkq d6 0 3",
                            chessBoard.GetFenPosition());
            chessBoard.MakePgnMove("ed6",string.Empty, string.Empty, string.Empty);
            ...
            chessBoard.MakePgnMove("e5",string.Empty, string.Empty, string.Empty);
            chessBoard.MakePgnMove("Nc3",string.Empty, string.Empty, string.Empty);
            chessBoard.MakePgnMove("f5",string.Empty, string.Empty, string.Empty);
            chessBoard.MakePgnMove("Qh5+",string.Empty, string.Empty, string.Empty);
            ...
            chessBoard.MakePgnMove("a8N",string.Empty, string.Empty, string.Empty);
