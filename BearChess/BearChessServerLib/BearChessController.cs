...
namespace www.SoLaNoSoft.com.BearChessServerLib
{
    public class BearChessController : IBearChessController
    {
        ...
        private readonly Dictionary<int, Dictionary<string, string>> _awaitedFens =
            new Dictionary<int, Dictionary<string, string>>();

        private readonly Dictionary<int, List<IElectronicChessBoard>> _allBoards =
            new Dictionary<int, List<IElectronicChessBoard>>();
