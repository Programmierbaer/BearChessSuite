...
namespace www.SoLaNoSoft.com.BearChess.EChessBoard
{
    public class InternalChessBoard : IInternalChessBoard
    {
        ...
        public bool WhiteWinsByKingPosition => (_bearChessBoard.GetKingFigure(Fields.COLOR_WHITE).Field == Fields.FD5 &&
                                                _bearChessBoard.GetKingFigure(Fields.COLOR_BLACK).Field == Fields.FE4) ||
                                              (_bearChessBoard.GetKingFigure(Fields.COLOR_WHITE).Field == Fields.FE4 &&
                                               _bearChessBoard.GetKingFigure(Fields.COLOR_BLACK).Field == Fields.FD5);

        public bool BlackWinsByKingPosition => (_bearChessBoard.GetKingFigure(Fields.COLOR_WHITE).Field == Fields.FD4 &&
                                               _bearChessBoard.GetKingFigure(Fields.COLOR_BLACK).Field == Fields.FE5) ||
                                               (_bearChessBoard.GetKingFigure(Fields.COLOR_WHITE).Field == Fields.FE5 &&
                                                _bearChessBoard.GetKingFigure(Fields.COLOR_BLACK).Field == Fields.FD4);

        public bool DrawByKingPosition => (_bearChessBoard.GetKingFigure(Fields.COLOR_WHITE).Field == Fields.FD5 &&
                                           _bearChessBoard.GetKingFigure(Fields.COLOR_BLACK).Field == Fields.FE5)
                                          ||
                                          (_bearChessBoard.GetKingFigure(Fields.COLOR_WHITE).Field == Fields.FD4 &&
                                           _bearChessBoard.GetKingFigure(Fields.COLOR_BLACK).Field == Fields.FE4) 
                                          ||
                                          (_bearChessBoard.GetKingFigure(Fields.COLOR_WHITE).Field == Fields.FD4 &&
                                           _bearChessBoard.GetKingFigure(Fields.COLOR_BLACK).Field == Fields.FD5)
                                          ||
                                          (_bearChessBoard.GetKingFigure(Fields.COLOR_WHITE).Field == Fields.FD5 &&
                                           _bearChessBoard.GetKingFigure(Fields.COLOR_BLACK).Field == Fields.FD4)
                                          ||
                                          (_bearChessBoard.GetKingFigure(Fields.COLOR_WHITE).Field == Fields.FE5 &&
                                           _bearChessBoard.GetKingFigure(Fields.COLOR_BLACK).Field == Fields.FE4)
