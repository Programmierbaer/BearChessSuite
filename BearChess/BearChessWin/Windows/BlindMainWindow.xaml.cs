...
namespace www.SoLaNoSoft.com.BearChessWin
{
    ...
    public partial class BlindMainWindow : Window
    {
        ...
        private void BlindMainWindow_OnKeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.Key == Key.Add)
            {
                if (_synthesizer.Rate < 10)
                {
                    _synthesizer.Rate++;
                    _synthesizer.SpeakForce($"{_rm.GetString("SpeechRateTest")} {_synthesizer.Rate}");
                    _configuration.SetIntValue("soundRate",_synthesizer.Rate);
                }
