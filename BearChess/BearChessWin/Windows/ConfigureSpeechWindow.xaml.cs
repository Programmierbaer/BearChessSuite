...
namespace www.SoLaNoSoft.com.BearChessWin
{
    ...
    public partial class ConfigureSpeechWindow : Window
    {
        ...
        public ConfigureSpeechWindow(ISpeech speechSynthesizer, Configuration config)
        {
            ...
            radioButtonLong.IsEnabled = checkBoxSpeechActive.IsChecked.Value; 
            radioButtonShort.IsEnabled = checkBoxSpeechActive.IsChecked.Value; 
            sliderSoundRate.IsEnabled = checkBoxSpeechActive.IsChecked.Value; 
            buttonDecrementRate.IsEnabled = checkBoxSpeechActive.IsChecked.Value; 
            buttonIncrementRate.IsEnabled = checkBoxSpeechActive.IsChecked.Value; 
            buttonPlayRate.IsEnabled = checkBoxSpeechActive.IsChecked.Value;
            sliderSoundRate.Value = config.GetIntValue("soundRate", 0);
        ...
        private void ButtonOk_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            var rate = ((int)sliderSoundRate.Value);
            _config.SetIntValue("soundRate", rate);
            _config.Save();
            DialogResult = true;
        }
        ...
        private void CheckBoxSpeechActive_OnChecked(object sender, RoutedEventArgs e)
        {
            ...
            radioButtonLong.IsEnabled = true;
            radioButtonShort.IsEnabled = true;
            sliderSoundRate.IsEnabled = true;
            buttonDecrementRate.IsEnabled = true;
            buttonIncrementRate.IsEnabled = true;
            buttonPlayRate.IsEnabled = true;
        }
        ...
        { 
            ...
            radioButtonLong.IsEnabled = false;
            radioButtonShort.IsEnabled = false;
            sliderSoundRate.IsEnabled = false;
            buttonDecrementRate.IsEnabled = false;
            buttonIncrementRate.IsEnabled = false;
            buttonPlayRate.IsEnabled = false;
        }
        ...
        private void ButtonDecrementSoundRate_OnClick(object sender, RoutedEventArgs e)
        {
            if (sliderSoundRate.Value > sliderSoundRate.Minimum)
            {
                sliderSoundRate.Value--;
            }
            
        }

        private void ButtonIncrementSoundRate_OnClick(object sender, RoutedEventArgs e)
        {
            if (sliderSoundRate.Value < sliderSoundRate.Maximum)
            {
                sliderSoundRate.Value++;
            }
        }

        private void SliderSoundRate_OnValueChanged(object sender, RoutedPropertyChangedEventArgs<double> e)
        {
            var rate = ((int)sliderSoundRate.Value);
            textBlockSoundRate.Text = rate.ToString();
        }

        private void ButtonPlayRate_OnClick(object sender, RoutedEventArgs e)
        {
            if (_speechSynthesizer.SpeechAvailable)
            {
                int rate = _speechSynthesizer.Rate;
                _speechSynthesizer.Rate = ((int)sliderSoundRate.Value);
                _speechSynthesizer.SpeakForce($"{_rm.GetString("SpeechRateTest")} {_speechSynthesizer.Rate}");
