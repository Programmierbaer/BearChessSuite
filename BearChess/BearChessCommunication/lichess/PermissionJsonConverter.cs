...
{
    public override List<TokenPermission>? Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        if (permissions != null)
        {
            ...
            var tokenPermissions = new List<TokenPermission>();
