...
{
    public class SentioSpectrumImpl : AbstractEBoardWrapper
    {


        public SentioSpectrumImpl(string name, string basePath) : base(name, basePath)
        {
        }

        public SentioSpectrumImpl(string name, string basePath, string comPortName, bool useBluetooth) : base(
            name, basePath, comPortName, useBluetooth, true, false, false)
        {

        }

        public SentioSpectrumImpl(string name, string basePath, EChessBoardConfiguration configuration) :
        ...
        {
            return new ChessBoard.ESentioSpectrumChessBoard(_basePath, _fileLogger, _configuration);
            //return new ChessBoard.ESentioChessBoard(_basePath, _fileLogger, _configuration);
        }

        protected override IEBoard GetEBoard(bool check)
        {
            return new ChessBoard.ESentioSpectrumChessBoard(_fileLogger);
